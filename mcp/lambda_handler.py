"""Lambda handler for Chaplin Health MCP Server using Function URL.
...
sys.path.insert(0, os.path.join(LAMBDA_TASK_ROOT, "agents"))
...
async def _handle_jsonrpc(body: dict) -> dict:
    ...
    if method == "initialize":
        ...
        result = InitializeResult(
            ...
            serverInfo=Implementation(name="Chaplin Health Events", version="1.0.0"),
        )
